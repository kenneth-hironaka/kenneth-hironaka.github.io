...
layout: essay
type: essay
title: "Understanding the Mind of A Software Engineer"
...
While I am not planning on becoming a software engineer in the near future, I do hope to go into the cybersecurity field. As cybersecurity has to secure everything from the electrical hardware all the way up to software applications, I will need to be able to work and communicate with many different types of people. Software engineers will be one of these types of people as new applications, whether it be a cybersecurity tool or a corporate application, need to have appropriate cybersecurity controls baked into its code.  
